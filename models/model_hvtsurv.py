...
#######################################
# Hvtsurv Implementation #
# Z. Shao, Y. Chen, H. Bian, J. Zhang, G. Liu, and Y. Zhang, “Hvtsurv: hierarchical vision transformer for patient-level survival prediction from whole slide image,” in Proceedings of the AAAI Conference on Artificial Intelligence, vol. 37, no. 2, 2023, pp. 2209–2217
#######################################
...
class HVTSurv(nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        h_all = [kwargs['x_path'].unsqueeze(0)] #list [[B,n,1024],...,[],[]]
